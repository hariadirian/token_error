...
<body>
  ...
  <table>
    <img src="img/unpaid2.png" height=100 width=100 align="left">
    <img src="img/tmii-logo.gif" height="100" width="100" align="right">
  </table>
  <header class="clearfix"></header>
  <div id="details" class="clearfix">
    <div id="client">
      <div class="to">KEPADA: <strong>{{ $customerData->first_name . $customerData->last_name }}</strong></div>
      <h2 class="name">{{ Auth::guard('customer')->user()->email }}</h2>
      <div class="address">-</div>
      <div class="phone">{{ $customerData->mobile_phone }}</div>
    </div>
    <div id="company">
  ...
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tbody>
      ...
      <tr>
        <td class="konten">{{ $unpaid->ticket_name }}</td>
        <td class="tiket">{{ $unpaid->ticket_qty }}</td>
        <td class="konten">{{ 'Rp. ' . $unpaid->diskon or '-' }}</td>
        <td class="konten">{{ $unpaid->total_tiket }}</td>
      </tr>
      @endforeach
    </tbody>
    <tfoot>
