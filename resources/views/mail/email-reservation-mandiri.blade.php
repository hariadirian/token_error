...
@section('content')
    ...
    td{
		...
		<tr>
			<td class="paragraph">
			Terima kasih, anda telah melakukan pemesanan tiket Taman Mini Indonesia Indah, informasi pemesanan terlampir dokumen (.pdf) di dalam email ini.
			</td>
		</tr>
		<tr>
			<td width="100%" height="25"></td>
		...
		<tr>
			<td class="paragraph">
				Tata cara dengan Mandiri SCM (Internet Banking) : 
			</td>
		</tr>
		<tr>
			<td class="paragraph">
				<ul>
					...
					<li><span>Pilih metode pembayaran Mandiri IB</span></li>
					<li><span>Periksa kembali data pemesanan, lalu
						klik Bayar</span></li>
					<li><span>Kamu akan langsung diarahkan ke
						halaman Mandiri SCM. Masukkan user ID dan
						password Internet Banking-mu</span></li>
		...
		<tr>
			<td class="paragraph">
				Note : Anda akan dikenakan biaya Rp 3.300 dengan menggunakan metode pembayaran Mandiri SCM (Internet Banking)
			</td>
		</tr>
