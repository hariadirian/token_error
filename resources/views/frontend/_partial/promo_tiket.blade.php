			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="section-title">
						<h2 class="title">PROMO PALING POPULER</h2>
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="banner banner-2"  style="box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.12), 0 -1px 3px 0 rgba(0, 0, 0, 0.08);">
						<img src="{{asset('frontend/img/side-banner-promo.jpg')}}" alt="">
						<div class="banner-caption">
							<h3 class="white-color" style="text-shadow:2px 3px rgba(0, 0, 0, 0.22);">PROMO LAINNYA</h3>
							<a href="{{ URL::asset('promotion') }}" class="primary-btn">Lihat Semua</a>
						</div>
					</div>
				</div>
				<!-- /banner -->
					...
					<div class="row">
						<div class="slider product-slick">
							...
							@foreach($promotion as $promo)
								@if($promo->promotioncode == '' || $promo->promotioncode == null) 
										...
										<div class="col-sm-4">
											<div class="product-btns pull-right" style="margin-top:0px;margin-bottom:20px;">
												{!! Form::open(['route' => 'ticket.add_to_cart']) !!}
													...
													{!! Form::hidden('cd', $promo->m_promotion_uu) !!}
													{!! Form::hidden('type_ticket', 'PROMOTION') !!}
