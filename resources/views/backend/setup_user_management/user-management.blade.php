                                ...
                                <div class="col-md-12">
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive" style="overflow-x: visible; ">
                                            <table selected-row="1" id="main-table" class="table table-hover js-exportable-ajax dataTable" data-source-tb="SetupUserManagement" width="100%" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th style=""></th>
...
@section('js')
    ...
    <script src="{{ asset('js/pages/_SetupUser.js') }}"></script>
