                    ...
                    <div class="card">
                        <div class="header">
                            <div id="main-table-search" class="row clearfix">
                                ...
                                </div><div class="col-xs-12 col-sm-2" style="padding-right:0px">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li style="width: 200px;">
                                            <a id="add_new" href="#" type="button" class="waves-effect m-r-20" data-toggle="modal" data-target="#modal">
                                ...
                                <div class="col-md-12">
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive" style="overflow-x: visible; ">
                                            <table selected-row="1" id="main-table" class="table table-hover js-exportable-ajax dataTable" data-source-tb="SetupOrgManagement" width="100%" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th style=""></th>
                                                        <th style="width:10px">No</th>
                                                        <th width="100px">Organization Name</th>
                                                        <th width="120px">Organization Type</th>
                                                        <th width="80px">Product Set</th>
...
@section('js')
    ...
    <script src="{{ asset('js/pages/_SetupOrg.js') }}"></script>
