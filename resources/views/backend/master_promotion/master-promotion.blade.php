                                ...
                                <div class="col-md-12">
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive" style="overflow-x: visible; ">
                                            <table selected-row="1" id="main-table" class="table table-hover js-exportable-ajax dataTable" data-source-tb="MasterPromotion" width="100%" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th style=""></th>
                                                        <th style="width:10px">No</th>
                                                        <th width="300px">Promo</th>
                                                        <th width="10px">Start</th>
                                                        <th width="20px">End</th>
