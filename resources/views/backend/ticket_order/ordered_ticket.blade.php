                        ...
                        <div class="header">
                            <div id="main-table-search" class="row clearfix">
                                <div class="col-xs-12 col-sm-3">
                                    <h2>ORDERED TICKET</h2>
                                </div>
                                <div class="col-xs-12 col-sm-1">
                                </div>
                                <div class="col-xs-12 col-sm-2">

                                 {!! Form::select('roles', ['Paid State Filter' =>  $paid_state->toArray()], null, ['class' => 'additional-filter form-control show-tick', 'name' => 'paid_state', 'id' => 'roles_option', 'data-live-search' => 'true', 'placeholder' => 'Please select']) !!}
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive" style="overflow-x: visible; ">
                                            <table selected-row="1" id="main-table" class="table table-hover js-exportable-ajax dataTable" data-source-tb="TicketOrder" width="100%" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th style=""></th>
                                                        <th width="10px">No</th>
